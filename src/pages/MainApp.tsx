...
const Reports = () => (
  <div className="p-6">
    <h1 className="text-2xl font-bold text-gray-900 mb-4">Reportes y Estadísticas</h1>
...
const InstructorsList = () => (
  <div className="p-6">
    <h1 className="text-2xl font-bold text-gray-900 mb-4">Nuestros Instructores</h1>
...
const routes: Route[] = [
  ...
  { path: '/instructor/classes', component: InstructorClasses, roles: ['instructor'] },
  { path: '/instructor/students', component: InstructorStudents, roles: ['instructor'] },
  { path: '/instructor/schedule', component: InstructorSchedule, roles: ['instructor'] },
  ...
  { path: '/client/instructors', component: InstructorsList, roles: ['cliente'] },
];
...
export const MainApp: React.FC = () => {
  ...
  const userRoutes = routes.filter(route => route.roles.includes(userRole || ''));
  ...
  const CurrentComponent = currentRoute?.component || (() => (
    <div className="p-6">
      ...
      <p className="text-gray-600">La página que buscas no existe o no tienes permisos para acceder.</p>
    </div>
  ));
